...
<title>Bizim Haber | Ekonomi Haberleri</title>
...
<?php $this->load->view('front/ekonomi/breadcrumb'); ?>
<div class="clearfix"></div>
...
<h3>KATEGORİ : EKONOMİ</h3>
</div>
<div class="clearfix"></div>
<div class='all-blogs'>
<?php $this->load->view('front/ekonomi/main_content'); ?>
</div>
<!-- Sayfalama -->
</div>
