...
<a itemprop="url" href="<?php echo base_url('anasayfa/spordetay/'); echo $bilgi['sef']; ?>" title="<?php echo $bilgi['title']; ?>" rel="bookmark">
...
<a href="<?php echo base_url('anasayfa/spordetay/'); echo $bilgi['sef']; ?>" title="<?php echo $bilgi['title']; ?>" rel="bookmark">
...
<div class="post-more">
<a class="button-default medium" href="<?php echo base_url('anasayfa/spordetay/'); echo $bilgi['sef']; ?>" title="<?php echo $bilgi['title']; ?>" rel="bookmark"><i class="fa fa-long-arrow-right"></i>Devamı</a>
</div>
<div class="clearfix"></div>
</div>
</article>
