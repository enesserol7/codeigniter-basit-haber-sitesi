...
<title>Bizim Haber | Magazin Haberleri</title>
...
<?php $this->load->view('front/magazin/breadcrumb'); ?>
<div class="clearfix"></div>
...
<h3>KATEGORİ : MAGAZİN</h3>
</div>
<div class="clearfix"></div>
<div class='all-blogs'>
<?php $this->load->view('front/magazin/main_content'); ?>
</div>
<!-- Sayfalama -->
</div>
