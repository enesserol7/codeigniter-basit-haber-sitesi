...
<div class="row">
<ul>
<?php $skat = 7; $sveriler = kultursoncek($skat); foreach ($sveriler as $sveri) { $kid = $sveri['id'] ?>
...
<div class="box-news-overlay"><a href="<?php echo base_url('anasayfa/kulturdetay/'); echo $sveri['sef']; ?>" title="?<php echo $sveri['title']; ?>" rel="bookmark"></a></div>
</div>
<div class="box-news-content">
<div class="box-news-title">
<a href="<?php echo base_url('anasayfa/kulturdetay/'); echo $sveri['sef']; ?>" title="?<php echo $sveri['title']; ?>" rel="bookmark"><?php echo $sveri['title']; ?></a>
</div>
...
<div class="post-more"><a class="button-default medium" href="<?php echo base_url('anasayfa/kulturdetay/'); echo $sveri['sef']; ?>" title="<?php echo $sveri['title']; ?>" rel="bookmark"><i class="fa fa-long-arrow-right"></i>Devamı</a></div>
</div>
<div class="clearfix"></div>
</div>
</li>
<?php } ?>
<?php $skat = 7; $veriler = kulturcek($skat); foreach ($veriler as $veri) { $kid = $veri['id'] ?>
<li class="col-md-6 col-sm-6 col-xs-6 col-mo-100">
