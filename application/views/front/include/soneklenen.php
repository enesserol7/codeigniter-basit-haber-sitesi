...
<a href="<?php echo base_url('anasayfa/siyasetdetay/'); echo $bilgi['sef']; ?>" title="<?php echo $bilgi['title']; ?>" rel="bookmark" class='post-img-link'><img alt='' width='280' height='230' src='<?php echo base_url(); echo $bilgi['tmb']; ?>'></a>
<?php }elseif ($bilgi['kategori'] == 'Ekonomi') { ?>
<a href="<?php echo base_url('anasayfa/ekonomidetay/'); echo $bilgi['sef']; ?>" title="<?php echo $bilgi['title']; ?>" rel="bookmark" class='post-img-link'><img alt='' width='280' height='230' src='<?php echo base_url(); echo $bilgi['tmb']; ?>'></a>
<?php }elseif ($bilgi['kategori'] == 'Sağlık') { ?>
<a href="<?php echo base_url('anasayfa/saglikdetay/'); echo $bilgi['sef']; ?>" title="<?php echo $bilgi['title']; ?>" rel="bookmark" class='post-img-link'><img alt='' width='280' height='230' src='<?php echo base_url(); echo $bilgi['tmb']; ?>'></a>
<?php }elseif ($bilgi['kategori'] == 'Spor') { ?>
<a href="<?php echo base_url('anasayfa/spordetay/'); echo $bilgi['sef']; ?>" title="<?php echo $bilgi['title']; ?>" rel="bookmark" class='post-img-link'><img alt='' width='280' height='230' src='<?php echo base_url(); echo $bilgi['tmb']; ?>'></a>
<?php }elseif ($bilgi['kategori'] == 'Magazin') { ?>
<a href="<?php echo base_url('anasayfa/magazindetay/'); echo $bilgi['sef']; ?>" title="<?php echo $bilgi['title']; ?>" rel="bookmark" class='post-img-link'><img alt='' width='280' height='230' src='<?php echo base_url(); echo $bilgi['tmb']; ?>'></a>
<?php }elseif ($bilgi['kategori'] == 'Kültür') { ?>
<a href="<?php echo base_url('anasayfa/kulturdetay/'); echo $bilgi['sef']; ?>" title="<?php echo $bilgi['title']; ?>" rel="bookmark" class='post-img-link'><img alt='' width='280' height='230' src='<?php echo base_url(); echo $bilgi['tmb']; ?>'></a>
<?php } ?>
</div>
...
<div class="post-meta-category"><i class="fa fa-folder-o"></i><a href="<?php echo base_url('anasayfa/'); echo $bilgi['katsef'] ?>" rel="category tag"><?php echo $bilgi['kategori']; ?></a></div>
<div class="post-meta-comment"><i class="fa fa-comments-o"></i><?php echo yorumcek($kid); ?> Yorum</div>
</div>
<div class="clearfix"></div>
<div class="post-inner">
<p><?php echo word_limiter($bilgi['icerik'],35); ?></35></p>
<?php if ($bilgi['kategori'] == 'Siyaset') { ?>
...
<?php }elseif ($bilgi['kategori'] == 'Ekonomi') { ?>
<div class="post-more"><a class="button-default medium" href="<?php echo base_url('anasayfa/ekonomidetay/'); echo $bilgi['sef']; ?>" rel="bookmark"><i class="fa fa-long-arrow-right"></i>Devamı</a></div>
<?php }elseif ($bilgi['kategori'] == 'Sağlık') { ?>
