...
<a itemprop="url" href="<?php echo base_url('anasayfa/kulturdetay/'); echo $bilgi['sef']; ?>" title="<?php echo $bilgi['title']; ?>" rel="bookmark">
...
<div class="post-meta-category"><i class="fa fa-folder-o"></i><a href="<?php echo base_url('anasayfa/kultur'); ?>" rel="category tag">Kültür</a></div>
...
<a href="<?php echo base_url('anasayfa/kulturdetay/'); echo $bilgi['sef']; ?>" title="<?php echo $bilgi['title']; ?>" rel="bookmark">
...
<div class="post-more">
<a class="button-default medium" href="<?php echo base_url('anasayfa/kulturdetay/'); echo $bilgi['sef']; ?>" title="<?php echo $bilgi['title']; ?>" rel="bookmark"><i class="fa fa-long-arrow-right"></i>Devamı</a>
</div>
<div class="clearfix"></div>
</div>
</article>
