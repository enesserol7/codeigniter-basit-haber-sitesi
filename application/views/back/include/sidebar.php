  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="<?php echo base_url('yonetim/koseyazarlari'); ?>"><i class="fa fa-circle-o"></i> Köşe Yazarları Listesi</a></li>
        </ul>
      </li>
      <li class="treeview">
        <a href="#">
      ...
      <li><a href="<?php echo base_url('yonetim/cikis'); ?>"><i class="fa fa-circle-o text-red"></i> <span><button type="button" class="btn btn-danger" name="button">Çıkış Yap</button></span></a></li>
      <li><a href="<?php echo base_url();?>" target="_blank"><i class="fa fa-circle-o text-yellow"></i> <span><button type="button" class="btn btn-warning" name="button">Siteye Git</button></span></a></li>
    </ul>
  </section>
</aside>
