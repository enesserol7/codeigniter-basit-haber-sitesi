...
<div class="row">
<div class="col-md-12">
<?php $this->load->view('front/include/galeri'); ?>
<div class="clearfix"></div>
</div>
</div>
</div>
...
<?php 	
	...
	$this->load->view('front/include/sondakika'); 
?>
<div class='clearfix'></div>
...
<aside class="sidebar">
<?php $this->load->view('front/include/arama'); ?>
<?php $this->load->view('front/include/smedya'); ?>
<?php $this->load->view('front/include/tablar'); ?>
<?php $this->load->view('front/include/sonhaberler'); ?>
<?php $this->load->view('front/include/koseyazari'); ?>
</aside>
</div>
<div class="clearfix"></div>
</div>
